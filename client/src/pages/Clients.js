  ...
  return (
    <GridToolbarContainer>
      ...
      <Button color="primary" startIcon={<AddIcon />}   onClick={() => navigate("/create")}>
       ...
       <GridToolbarExport csvOptions={{ disableToolbarButton: true, pageStyle: '.MuiDataGrid-root .MuiDataGrid-main { color: rgba(0, 0, 0, 0.87); }' }} />
     </ThemeProvider>
    </GridToolbarContainer>
  );
}
...
EditToolbar.propTypes = {
 ...
 const navigate = useNavigate();
  ...
  const columns = [
    ...
    { field: 'adressDepart', headerName: 'Adresse',  width: 400, type: 'number', editable: true },
    {
      field: 'start',
      headerName: 'Date/heure de départ',
      type: 'text',
      width: 180,
      editable: true,
    },
    {
      field: ' end',
      headerName: 'Date/heure de retour',
      type: 'text',
      width: 220,
      editable: true,
    },
